...
(deftest test-inconsistencies
  (let [jg (-> (new-just-graph)
    ...
    (is (not (nil? jg-expand-ab)))
    (is (not (nil? jg-expand-bc)))
    (is (not (nil? jg-expand-ac)))
    (is (nil? jg-expand-abc))
    (is (nil? jg-expand-acb))
    (is (nil? jg-expand-bac))
    (is (nil? jg-expand-bca))
    (is (nil? jg-expand-cba))
    (is (nil? jg-expand-cab))
    (is (nil? jg-expand-d))))
